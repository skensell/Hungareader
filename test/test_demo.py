#
# This is a demo of how to do unit testing in appengine.
# 
# I am using the test_runner provided by Google (see test_runner.py).
# From the terminal inside root run:
#
# python test_runner.py /usr/local/google_appengine /Users/Scott/Desktop/Hungareader/test
#
#
